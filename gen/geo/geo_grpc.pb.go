...
const (
	GeoProvider_AddressSearch_FullMethodName = "/geo.GeoProvider/AddressSearch"
	GeoProvider_GeoCode_FullMethodName       = "/geo.GeoProvider/GeoCode"
)
...
type GeoProviderClient interface {
	AddressSearch(ctx context.Context, in *AddressSearchRequest, opts ...grpc.CallOption) (*AddressResponse, error)
...
func (c *geoProviderClient) AddressSearch(ctx context.Context, in *AddressSearchRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
...
func (c *geoProviderClient) GeoCode(ctx context.Context, in *GeoCodeRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddressResponse)
...
type GeoProviderServer interface {
	AddressSearch(context.Context, *AddressSearchRequest) (*AddressResponse, error)
...
func (UnimplementedGeoProviderServer) AddressSearch(context.Context, *AddressSearchRequest) (*AddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddressSearch not implemented")
}
func (UnimplementedGeoProviderServer) GeoCode(context.Context, *GeoCodeRequest) (*AddressResponse, error) {
